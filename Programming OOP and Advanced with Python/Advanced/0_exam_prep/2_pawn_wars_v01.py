...
while game_on and u9_hits < 3 and destroyed_ships < 3:
    ...
    nazi_row, nazi_col = coordsOf(rows, "S")
    brit_row, brit_col = coordsOf(rows, "C")
    mine_row, mine_col = coordsOf(rows, "*")

    nazi_pos = (nazi_row, nazi_col)
    brit_pos = (brit_row, brit_col)
    mine_pos = (mine_row, mine_col)
